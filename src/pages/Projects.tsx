          ...
          <div className="grid md:grid-cols-2 gap-8">
            ...
            <div className="space-y-6">
              ...
              <Link to="/gamification">
                <Card className="glass-card border-success/20 cursor-pointer hover:scale-105 transition-transform">
                  <CardHeader className="pb-3">
                    <CardTitle className="text-lg flex items-center gap-2">
          ...
          <CardContent>
            <div className="space-y-3">
              {currentProject.objectives.map((objective, index) => (
                <div key={index} className="flex items-center gap-3 p-3 rounded-lg bg-secondary/20 border border-secondary/30 cursor-pointer hover:bg-secondary/30 transition-colors">
          ...
          <CardContent>
            <div className="grid grid-cols-2 gap-3">
              {currentProject.concepts.map((concept) => (
                <div key={concept} className="p-3 rounded-lg bg-success/10 border border-success/20 text-center cursor-pointer hover:bg-success/20 transition-colors">
        ...
        <CardContent>
          <div className="space-y-4">
            {pastProjects.map((project, index) => (
              <div key={index} className="flex items-center justify-between p-4 rounded-lg border border-secondary/30 bg-secondary/10 cursor-pointer hover:bg-secondary/20 transition-colors">
                <div className="flex items-center gap-3">

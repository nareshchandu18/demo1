...
export default function Dashboard() {
  ...
  const quickAccessGrid = [
    ...
    { title: 'Resume', icon: FileText, color: 'hsl(var(--primary))', href: '#', status: '72% Complete' },
    { title: 'Coach', icon: MessageCircle, color: 'hsl(var(--accent))', href: '/study-coach', status: 'Available' }
  ];
          ...
          <CardContent className="space-y-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              {weeklyBreakdown.resources.map((resource, index) => (
                <div key={index} className="p-3 rounded-lg bg-surface-elevated/50 hover:bg-surface-elevated transition-colors">
                  <div className="flex items-center gap-2 mb-2">
              ...
              <CardContent>
                <div className="grid grid-cols-2 gap-3">
                  {quickAccessGrid.map((item, index) => (
                    <Card 
                      key={index} 
                      className="p-4 cursor-pointer hover:scale-105 transition-all duration-300 bg-gradient-to-br from-white/5 to-white/10 border-white/20 hover:border-primary/40 group"
                    >
              ...
              <CardContent>
                <div className="space-y-4">
                  ...
                  <div className="flex gap-2">
                    ...
                    <Button size="sm" className="flex-1 bg-gradient-to-r from-primary to-achievement">
            ...
            <Card className="glass-card">
              ...
              <CardContent className="space-y-3">
                {notifications.map((notification) => (
                  <div key={notification.id} className="p-3 rounded-lg bg-surface-elevated/30 hover:bg-surface-elevated/50 transition-colors">
